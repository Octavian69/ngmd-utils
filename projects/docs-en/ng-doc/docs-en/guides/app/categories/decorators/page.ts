...
const headerContent: string = `<h1 class="ngde ngde" id="decorators" href="decorators" headinglink="true">Decorators<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="decorators"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-kddcvmes',
