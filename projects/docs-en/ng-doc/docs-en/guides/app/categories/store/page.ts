...
const headerContent: string = `<h1 class="ngde ngde" id="store" href="store" headinglink="true">Store<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="store"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-0k9342wu',
