...
const headerContent: string = `<h1 class="ngde ngde" id="state" href="state" headinglink="true">State<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="state"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-yyp54n2k',
