...
const headerContent: string = `<h1 class="ngde ngde" id="withenvironment" href="initializer/features/with-environment" headinglink="true">withEnvironment<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="withenvironment"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-qp5nlzcj',
