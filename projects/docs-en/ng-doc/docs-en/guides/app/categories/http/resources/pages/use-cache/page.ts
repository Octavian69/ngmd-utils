...
const headerContent: string = `<h1 class="ngde ngde" id="usecache" href="http/resources/use-cache" headinglink="true">useCache<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="usecache"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-0bjmp3yi',
