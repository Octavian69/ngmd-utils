...
const headerContent: string = `<h1 class="ngde ngde" id="useget" href="http/resources/use-get" headinglink="true">useGet<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="useget"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-oig4x95k',
