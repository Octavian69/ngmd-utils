...
const headerContent: string = `<h1 class="ngde ngde" id="introduction" href="http/introduction" headinglink="true">Introduction<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="introduction"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-ox8widrb',
