...
const headerContent: string = `<h1 class="ngde ngde" id="actions" href="actions" headinglink="true">Actions<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="actions"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-xqerv129',
