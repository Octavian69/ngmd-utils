...
const headerContent: string = `<h1 class="ngde ngde" id="cookies" href="cookies" headinglink="true">Cookies<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="cookies"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-duerh0b2',
