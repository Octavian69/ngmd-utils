...
const headerContent: string = `<h1 class="ngde ngde" id="providetitlestrategy" href="strategies/provide-title-strategy" headinglink="true">provideTitleStrategy<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="providetitlestrategy"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-t9zf46dc',
