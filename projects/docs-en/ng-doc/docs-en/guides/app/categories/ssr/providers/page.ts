...
const headerContent: string = `<h1 class="ngde ngde" id="providers" href="ssr/providers" headinglink="true">Providers<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="providers"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-xcwbl4ba',
