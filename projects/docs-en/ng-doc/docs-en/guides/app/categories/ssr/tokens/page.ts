...
const headerContent: string = `<h1 class="ngde ngde" id="tokens" href="ssr/tokens" headinglink="true">Tokens<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="tokens"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-gd4k870f',
