...
const headerContent: string = `<h1 class="ngde ngde" id="withtagsurlsmap" href="interceptor/features/with-tags-urls-map" headinglink="true">withTagsUrlsMap<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="withtagsurlsmap"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-7wks7t1i',
