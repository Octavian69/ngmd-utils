...
import entry from '../../../../../../../../../src/app/categories/interceptor/http-context-tokens/skip-headers-modification/ng-doc.page';
import {PLAYGROUND_COMPONENTS, PLAYGROUND_PROVIDERS} from '../playgrounds';
import demoAssets from '../demo-assets';

const pageContent: string = `<p class="ngde">Imported from <code class="ngde">@ngmd/utils/interceptor</code></p><hr class="ngde"><h2 id="description" href="interceptor/http-context-tokens/skip-headers-modification" headinglink="true" class="ngde">Description<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="description"></ng-doc-heading-anchor></h2><p class="ngde"><code class="ngde ng-doc-code-with-link"><a href="https://angular.dev/api/common/http/HttpContextToken" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the Angular documentation.">HttpContextToken</a></code> used to disable request processing by <em class="ngde">feature functions</em> of type <code class="ngde ng-doc-code-with-link"><a href="/interceptor/features/with-headers#headersfeature" class="ng-doc-code-anchor ngde">HeadersFeature</a></code>, <code class="ngde ng-doc-code-with-link"><a href="/interceptor/features/with-headers-handler#headershandlerfeature" class="ng-doc-code-anchor ngde">HeadersHandlerFeature</a></code></p><h2 id="usage" href="interceptor/http-context-tokens/skip-headers-modification" headinglink="true" class="ngde">Usage<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="usage"></ng-doc-heading-anchor></h2><pre class="shiki shiki-themes github-light ayu-dark" style="background-color:#fff;--shiki-dark-bg:#0b0e14;color:#24292e;--shiki-dark:#bfbdb6" tabindex="0"><code class="language-ts"><span class="line"><span style="color:#D73A49;--shiki-dark:#FF8F40" class="ngde">import</span><span style="color:#24292E;--shiki-dark:#BFBDB6" class="ngde"> \{ <a href="/interceptor/http-context-tokens/skip-headers-modification#skip_headers_modification" class="ng-doc-code-anchor ngde">SKIP_HEADERS_MODIFICATION</a> \} </span><span style="color:#D73A49;--shiki-dark:#FF8F40" class="ngde"><a href="https://rxjs.dev/api/index/function/from" class="ng-doc-code-anchor ngde" ngDocTooltip="External link the RxJS documentation.">from</a></span><span style="color:#032F62;--shiki-dark:#AAD94C" class="ngde"> '@ngmd/utils/interceptor'</span><span style="color:#24292E;--shiki-dark:#BFBDB6B3" class="ngde">;</span></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#BFBDB6" class="ngde">    url</span><span style="color:#24292E;--shiki-dark:#BFBDB6B3" class="ngde">:</span><span style="color:#032F62;--shiki-dark:#AAD94C" class="ngde"> '@/users'</span><span style="color:#24292E;--shiki-dark:#BFBDB6B3" class="ngde">,</span></span>
...
<span class="line"><span style="color:#24292E;--shiki-dark:#BFBDB6" class="ngde">    \}</span><span style="color:#24292E;--shiki-dark:#BFBDB6B3" class="ngde">,</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#BFBDB6" class="ngde">  \})</span><span style="color:#24292E;--shiki-dark:#BFBDB6B3" class="ngde">;</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#BFBDB6" class="ngde">\}</span></span></code></pre><p class="ngde">Now all <em class="ngde">feature functions</em> for processing <em class="ngde">http</em> headers will be ignored for this request.</p>`

@Component({
  selector: 'ng-doc-page-4o1z2oa9',
