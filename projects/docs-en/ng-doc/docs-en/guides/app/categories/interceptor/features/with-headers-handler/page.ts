...
const headerContent: string = `<h1 class="ngde ngde" id="withheadershandler" href="interceptor/features/with-headers-handler" headinglink="true">withHeadersHandler<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="withheadershandler"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-k3lkjw69',
