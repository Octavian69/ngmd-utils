...
const headerContent: string = `<h1 class="ngde ngde" id="withtagsurlshandler" href="interceptor/features/with-tags-urls-handler" headinglink="true">withTagsUrlsHandler<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="withtagsurlshandler"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-9yn3xf17',
