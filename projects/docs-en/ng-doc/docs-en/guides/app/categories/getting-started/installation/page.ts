...
const headerContent: string = `<h1 class="ngde ngde" id="installation" href="getting-started/installation" headinglink="true">Installation<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="installation"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-lzh9kzkf',
