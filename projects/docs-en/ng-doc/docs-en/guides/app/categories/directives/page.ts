...
const headerContent: string = `<h1 class="ngde ngde" id="directives" href="directives" headinglink="true">Directives<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="directives"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-gz3ch0om',
