...
const headerContent: string = `<h1 class="ngde ngde" id="platformservice" href="services/platform-service" headinglink="true">PlatformService<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="platformservice"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-yrxm6sc7',
