...
const headerContent: string = `<h1 class="ngde ngde" id="handlers" href="handlers" headinglink="true">Handlers<ng-doc-heading-anchor class="ng-doc-anchor ngde" anchor="handlers"></ng-doc-heading-anchor></h1>`

@Component({
  selector: 'ng-doc-page-wrapper-aofrpsu5',
